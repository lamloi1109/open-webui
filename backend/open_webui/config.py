...
#     "CORS_ALLOW_ORIGIN", "http://localhost:5173;http://localhost:7777; http://172.16.*:5173; http://172.16.*:7777"
# ).split(";")
...
WEAVIATE_HTTP_PORT = int(os.environ.get("WEAVIATE_HTTP_PORT", "7777"))
